...
--
-- TOC entry 2976 (class 0 OID 33171)
-- Dependencies: 206
-- Data for Name: auspicia_equipo; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY auspicia_equipo ("nombreEquipo", "nombrePatrocinador", monto) FROM stdin;
\.


--
-- TOC entry 2981 (class 0 OID 33242)
-- Dependencies: 211
-- Data for Name: auspicia_i_torneo; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY auspicia_i_torneo ("nombrePatrocinador", id_i_torneo, monto) FROM stdin;
\.


--
-- TOC entry 2971 (class 0 OID 33082)
-- Dependencies: 201
-- Data for Name: automovil; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY automovil (matricula, modelo) FROM stdin;
\.
...
-- Dependencies: 208
-- Data for Name: carrera; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY carrera (ubicacion, terreno) FROM stdin;
\.


--
-- TOC entry 2966 (class 0 OID 32976)
-- Dependencies: 196
-- Data for Name: competidor; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY competidor (rut, nacionalidad, nombres, "apPaterno", "apMaterno", "nombreEquipo") FROM stdin;
\.


--
-- TOC entry 2970 (class 0 OID 33056)
-- Dependencies: 200
-- Data for Name: copiloto; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY copiloto ("rutCompetidor") FROM stdin;
\.


--
-- TOC entry 2984 (class 0 OID 33298)
-- Dependencies: 214
-- Data for Name: corre_i_automovil; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY corre_i_automovil (id_i_automovil, id_i_carrera, "tiempoResultado") FROM stdin;
\.


--
-- TOC entry 2967 (class 0 OID 32986)
-- Dependencies: 197
-- Data for Name: equipo; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY equipo (nombre, "numPilotos", "numCopilotos") FROM stdin;
\.


--
-- TOC entry 2972 (class 0 OID 33095)
-- Dependencies: 202
-- Data for Name: equipo_automovil; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY equipo_automovil ("matriculaAutomovil", "nombreEquipo") FROM stdin;
\.


--
-- TOC entry 2973 (class 0 OID 33113)
-- Dependencies: 203
-- Data for Name: i_automovil; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY i_automovil (id, "matriculaAutomovil", cilindrada, "rutPiloto", "rutCopiloto") FROM stdin;
\.


--
-- TOC entry 2980 (class 0 OID 33223)
-- Dependencies: 210
-- Data for Name: i_carrera; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY i_carrera (id, "ubicacionCarrera", "fecComp", "cilindradaMin", "cilindradaMax", "id_i_Torneo") FROM stdin;
\.


--
-- TOC entry 2979 (class 0 OID 33211)
-- Dependencies: 209
-- Data for Name: i_torneo; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY i_torneo (id, "idTorneo", "fecInicio", "fecTermino", "costoIngreso", "cantCarreras") FROM stdin;
\.


--
-- TOC entry 2969 (class 0 OID 33042)
-- Dependencies: 199
-- Data for Name: modelo_marca; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY modelo_marca (modelo, marca) FROM stdin;
\.


--
-- TOC entry 2982 (class 0 OID 33261)
-- Dependencies: 212
-- Data for Name: participa_equipo; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY participa_equipo ("nombreEquipo", id_i_torneo) FROM stdin;
\.


--
-- TOC entry 2974 (class 0 OID 33136)
-- Dependencies: 204
-- Data for Name: patrocinador; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY patrocinador (nombre, nacionalidad) FROM stdin;
\.


--
-- TOC entry 2975 (class 0 OID 33158)
-- Dependencies: 205
-- Data for Name: patrocinador_direccion; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY patrocinador_direccion ("nombrePatrocinador", direccion) FROM stdin;
\.


--
-- TOC entry 2968 (class 0 OID 33021)
-- Dependencies: 198
-- Data for Name: piloto; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY piloto ("rutCompetidor") FROM stdin;
\.


--
-- TOC entry 2985 (class 0 OID 33313)
-- Dependencies: 215
-- Data for Name: resultado; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY resultado (tiempo, puntaje) FROM stdin;
\.


--
-- TOC entry 2977 (class 0 OID 33190)
-- Dependencies: 207
-- Data for Name: torneo; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY torneo (id, nombre, "cilindradaMin", "cilindradaMax") FROM stdin;
\.


--
-- TOC entry 2983 (class 0 OID 33279)
-- Dependencies: 213
-- Data for Name: torneo_carrera; Type: TABLE DATA; Schema: rally; Owner: postgres
--

COPY torneo_carrera ("idTorneo", "ubicacionCarrera") FROM stdin;
\.
